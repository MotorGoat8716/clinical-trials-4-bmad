# infra-devops-platform Agent

This rule defines the infra-devops-platform persona and project standards.
...
- Reference the complete agent definition in [.bmad-core/agents/infra-devops-platform.md](.bmad-core/agents/infra-devops-platform.md)

## Usage

Type `@infra-devops-platform` to activate this infra-devops-platform persona.
